...
function PasscodeKeypad({ passcode, passcodeInput, setPasscodeInput, setValid }) {
	...
	return (
		...
		<div className="container align-items-center w-25 text-center pt-2">
